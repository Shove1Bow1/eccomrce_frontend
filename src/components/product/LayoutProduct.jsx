...
const LayoutProduct = (props) => {
    ...
    return (
        <div className="flex flex-col items-start p-[16px] gap-[16px] w-[268px] h-[332px] border-[#D1D1D1] border-[1px] rounded-[12px] bg-white">
            <Image className="left-[0px] right-[0px] top-[0px] bottom-[0px] bg-[#F9F9F9] rounded-[12px] w-[236px] h-[180px]"
                title={productName}
                alt="img"
                src={image}
            ...
            <div className="flex flex-col items-start w-[236px] h-[184px] padding-[0px] self-stretch">
                ...
                <div className="w-[237px] h-[36px] relative self-stretch flex">
                    ...
                    <Modal
                        ...
                        width={600}
                        footer={[
                            <span style={{ textAlign: 'left', float: 'left' }}>Giá:  <b>{generateThousand(price)} VNĐ</b> </span>,
                            ...
                            <Row gutter={24} >
                                <Col span={6} style={{ display: 'flex', justifyContent: 'center' }}>
                                    <Image
                                        src={`${image}`}
                                        width={120}
                                        style={{ boxShadow: '1px 1px 1px #bfbfbf', borderRadius: '5px' }}
                                        fallback="data:image/png;base64," />
                                </Col>
                                <Col span={18}>
